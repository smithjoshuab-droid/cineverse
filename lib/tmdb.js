...
const SERVICES = {
  netflix:    { name: 'Netflix',      ids: [8, 1796] },
  prime:      { name: 'Prime Video',  ids: [9, 119, 2100] },
  disney:     { name: 'Disney+',      ids: [337] },
  max:        { name: 'Max',          ids: [1899, 384, 616] },
  hulu:       { name: 'Hulu',         ids: [15] },
  apple:      { name: 'Apple TV+',    ids: [350] },
  peacock:    { name: 'Peacock',      ids: [386, 387] },
  paramount:  { name: 'Paramount+',   ids: [531, 1770] }
};
...
module.exports = { SERVICES, getGenres, discover, trending, upcoming, search, details, providers, imdbIdFor };
